...
Here is betting and value betting analysis. You can use this for example on this website:  https://www.programiz.com/python-programming/online-compiler/

And you just have to copy the code and paste it into the main.py file and press RUN
